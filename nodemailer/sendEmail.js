...
let index = 0;
const emails = [
  { email: "eslamgalal0312@gmail.com", pass: "cctayrscwzungzpw" },
  { email: "eslamgalal312@gmail.com", pass: "iimdtycesdkxwgii" },
];
let email = "eslamgalal0312@gmail.com";
let pass = "cctayrscwzungzpw";
...
try {
	counter+=1;
    if(counter === 200 && index < 2){
		email = emails[index+1].email;
        pass = emails[index+1].pass;
        index+=1;
    }
	sendEmail();
