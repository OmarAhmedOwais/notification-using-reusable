...
const dynamicText = "This is dynamically generated text.";
const islam = 'islam sayed galal mohamed'
...
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; color: #17c297;">Quantity : ${product.quantaity} x $${product.price}</span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 24px; line-height: 28.8px;"><strong><span style="line-height: 28.8px; font-size: 24px;">$${product.quantaity * product.price}</span></strong></span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><strong><span style="font-size: 30px; line-height: 36px;">$${totalPrice}</span></strong></p>
  </div>
...
const pdfOptions = {
  format: "Letter", // PDF page format
  border: "10mm", // Page border
};

const outputPath = path.join(__dirname, "invoice.pdf"); // Specify the output file path

// Generate PDF from HTML and save it to the specified location
pdf.create(emailTemplate, pdfOptions).toFile(outputPath, (err, res) => {
  if (err) {
...
// // Define your dynamic text
// const dynamicText = 'This is dynamically generated text.';
// const email = "islamgalal@sarri.sa";
...
// const outputPath = path.join(__dirname, 'dynamic_text.pdf'); // Specify the output file path
